...
return [
    'HUF_MERCHANT' => env('SIMPLE_CLIENT_ID',''), //merchant account ID (HUF)
    'HUF_SECRET_KEY' => env('SIMPLE_SECRET',''), //secret key for account ID (HUF)

    'CURL' => true, //use cURL or not
    'SANDBOX' => true, //true: sandbox transaction, false: live transaction
    'PROTOCOL' => 'http', //http or https

    'BACK_REF' => $_SERVER['HTTP_HOST'] . '/payments/simple',		   //url of payment backref page
    'TIMEOUT_URL' => $_SERVER['HTTP_HOST'] . '/payments/simple',     //url of payment timeout page
